  ...
  useGSAP(
    () => {
      ...
      tl.from(".contrib-card", { y: 32, opacity: 0, duration: 0.8 })
        .from(".contrib-eyebrow", { y: 14, opacity: 0, duration: 0.4 }, "-=0.4")
        .from(
          ".contrib-headline",
          ...
          <div className="relative grid gap-10 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="contrib-body mt-5 max-w-xl text-[16px] leading-relaxed text-[color:var(--text-secondary)]">
                Built something reusable auth flow, payment widget, AI feature,
                dashboard primitive? Open a pull request. Once merged, your
                component gets a permanent doc page and is loaded by every
                Claude Code agent reading the registry.
              </p>
