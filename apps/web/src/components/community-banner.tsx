  ...
  useGSAP(
    () => {
      ...
      tl.from(".community-card", { y: 28, opacity: 0, duration: 0.8 })
        ...
        .from(
          ".community-stat",
          { y: 8, opacity: 0, stagger: 0.06, duration: 0.35 },
          "-=0.2",
        )
        .from(
          ".community-cta > *",
          ...
          <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="community-body mt-4 max-w-xl text-[15.5px] leading-relaxed text-[color:var(--text-secondary)]">
                Indie hackers, freelancers, founders we trade screenshots, debug
                agent loops together, and share what's working in the framework.
                Drop in to ask anything.
              </p>
            ...
            <div className="hidden md:block">
              <div className="relative grid h-32 w-32 place-items-center">
                ...
                />
                <div className="relative grid h-20 w-20 place-items-center rounded-full bg-[#25D366] shadow-[0_8px_30px_rgba(37,211,102,0.45)]">
