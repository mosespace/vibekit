    ...
    <div className="terminal shadow-[0_32px_80px_rgba(217,119,87,0.18)]">
      ...
      <div className="p-5 space-y-1 text-[12.5px] leading-[1.9]">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-0.5">
              ...
              <span className="text-[#A89880]">
                A SaaS for school management teachers, students, fees
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 pl-5">
          ...
          <span className="text-[#3D3228] text-[11px]">
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-0.5">
              <span className="text-[#705D4A]">│</span>
              <span className="text-[#A89880]">
                Claude Code will interview you and generate 4 project files
              </span>
            </div>
          </div>
        </div>
...
export function Hero() {
  ...
  useGSAP(
    () => {
      ...
      tl.from(".hero-eyebrow", { y: 12, opacity: 0, duration: 0.5 })
        .from(
          ".hero-headline span",
          { y: 28, opacity: 0, duration: 0.7, stagger: 0.05 },
          "-=0.3",
        )
        ...
        .from(
          ".hero-provider",
          { y: 6, opacity: 0, duration: 0.3, stagger: 0.06 },
          "-=0.3",
        );
    },
    { scope: root },
  ...
  return (
    <section
      ref={root}
      className="relative isolate overflow-hidden pt-32 sm:pt-40 pb-16"
    >
      {/* Warm grid */}
      <div
        className="pointer-events-none absolute inset-0 -z-10 grid-pattern opacity-100"
        aria-hidden
      />
