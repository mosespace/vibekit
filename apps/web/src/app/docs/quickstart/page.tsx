...
const steps: Step[] = [
  {
    ...
    terminal: [
      ...
      },
      {
        prefix: "✔",
        prefixColor: "#27C93F",
        text: "Project scaffolded → my-app/",
        textColor: "#A89880",
      },
      {
        prefix: "│",
  ...
  },
  {
    ...
    terminal: [
      ...
      },
      {
        prefix: "│",
        prefixColor: "#705D4A",
        text: "A school management SaaS for Uganda  teachers, students,",
        textColor: "#A89880",
      },
      {
        prefix: "│",
        prefixColor: "#705D4A",
        text: "parents, fees, and grades. Parents pay monthly.",
        textColor: "#A89880",
      },
    ],
  },
    ...
    terminal: [
      {
        prefix: "●",
        prefixColor: "#D97757",
        text: "Claude Code   → installed · authenticated",
        textColor: "#D97757",
      },
      {
        prefix: "○",
      ...
      },
      {
        prefix: "◆",
        prefixColor: "#D97757",
        text: "Which provider should build your project?",
        textColor: "#F5EFE6",
      },
      {
        prefix: "│",
    ...
    terminal: [
      {
        prefix: "◆",
        prefixColor: "#D97757",
        text: "Start Claude Code to build Phase 1?",
        textColor: "#F5EFE6",
      },
      {
        prefix: "✔",
        prefixColor: "#27C93F",
        text: "Phase 1: Foundation  done",
        textColor: "#A89880",
      },
      {
        prefix: "✔",
        prefixColor: "#27C93F",
        text: "Pre-deploy audit passed",
        textColor: "#A89880",
      },
      {
        prefix: "▶",
    ...
    <div className="mt-5 rounded-[var(--radius-md)] border border-[#2A221A] bg-[#0E0C09] px-4 py-3.5 font-mono text-[12.5px] leading-[1.9]">
      {lines.map((l, i) => (
        <div key={i} className="flex items-start gap-2">
          <span
            style={{ color: l.prefixColor, minWidth: "1.5ch", flexShrink: 0 }}
          >
            {l.prefix}
          </span>
        ...
        <article className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <header className="mt-8 border-b border-[color:var(--border)] pb-10">
            ...
            <p className="mt-5 text-[18px] leading-relaxed text-[color:var(--text-secondary)]">
              One terminal command. Scaffold → describe → pick provider → plan →
              build → ship. Every step happens in your terminal no browser tabs,
          ...
          <div className="mt-16 rounded-[var(--radius-xl)] border border-[color:var(--accent)]/30 bg-[color:var(--bg-elevated)] p-6">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-[color:var(--text-primary)]">
              Five steps from idea to production. The CLI handles everything
              after step 1 just answer the prompts and let your AI provider do
              the work.
            </p>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Run the CLI, describe your idea, pick an AI provider, plan, build, and ship a production Next.js app.",
            totalTime: "PT10M",
            step: steps.map((s) => ({
              "@type": "HowToStep",
              position: s.n,
